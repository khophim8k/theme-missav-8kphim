...
namespace Kho8k\MissAV\Controllers;
...
class MissAVController
{
    public function index(Request $request)
    {
        if ($request['search'] || $request['filter']) {
            ...
            return view('themes::missav.catalog', [
                'data' => $data,
                'search' => $request['search'],
                'section_name' => "Tìm kiếm phim: $request->search"
            ]);
        }
        return view('themes::missav.index', [
    ...
    public function getMovieOverview(Request $request)
    {
        ...
        return view('themes::missav.single', [
            'currentMovie' => $movie,
    ...
    public function getEpisode(Request $request)
    {
        ...
        return view('themes::missav.episode', [
            'currentMovie' => $movie,
            'movie_related' => $movie_related,
            'episode' => $episode,
